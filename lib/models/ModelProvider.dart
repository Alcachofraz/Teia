...
class ModelProvider implements ModelProviderInterface {
  ...
  @override
  List<ModelSchema> modelSchemas = [Chapter.schema, ChapterGraph.schema, Page.schema, Snippet.schema, Story.schema, User.schema, UsersWriteStories.schema];
