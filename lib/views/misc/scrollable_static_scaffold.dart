...
class ScrollableStaticScaffold extends StatefulWidget {
  ...
  const ScrollableStaticScaffold({
    Key? key,
  ...
  @override
  State<ScrollableStaticScaffold> createState() => _ScrollableStaticScaffoldState();
}

class _ScrollableStaticScaffoldState extends State<ScrollableStaticScaffold> {
